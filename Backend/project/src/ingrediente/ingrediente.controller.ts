...
export class IngredienteController {
    ...
    @Get('suUsuario/:idIngrediente')
    async obtenerUsuarioPorIdComida(
        @Param() paramParams,
        @Res() response
    ) {
        const usuario = await this._ingredienteService.obtenerUsuarioPorIngredienteId(paramParams.idIngrediente);
